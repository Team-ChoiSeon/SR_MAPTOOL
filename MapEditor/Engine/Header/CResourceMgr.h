...
public:
    ...
    CTexture* LoadNormal(const string& texturePath);
    ...
    CTexture* GetNormal(const std::string& key);
    ...
    const unordered_map<string, CTexture*>& Get_NormallMap() { return m_normalMap; }
    ...
    const vector<string>& Get_NormallName() { return m_normalName; }
